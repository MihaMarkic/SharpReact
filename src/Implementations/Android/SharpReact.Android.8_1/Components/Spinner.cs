...
{
	public  partial class Spinner<TProps, TElement>: AbsSpinner<TProps, TElement>
		...
		where TElement : global::Android.Widget.Spinner
	{
		...
		public override void AssignProperties(ISharpRenderer<global::Android.Views.View> renderer, int level, NewState newState, TProps previous, TProps nextProps)
		{
			...
			PostAssignSpinnerProperties(renderer, level, newState, previous, nextProps);
		}
		partial void PostAssignSpinnerProperties(ISharpRenderer<global::Android.Views.View> renderer, int level, NewState newState, TProps previous, TProps nextProps);
