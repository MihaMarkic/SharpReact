...
{
	public  partial class RatingBar<TProps, TElement>: AbsSeekBar<TProps, TElement>
		...
		where TElement : global::Android.Widget.RatingBar
	{
		...
		public override void AssignProperties(ISharpRenderer<global::Android.Views.View> renderer, int level, NewState newState, TProps previous, TProps nextProps)
		{
			...
			PostAssignRatingBarProperties(renderer, level, newState, previous, nextProps);
		}
		partial void PostAssignRatingBarProperties(ISharpRenderer<global::Android.Views.View> renderer, int level, NewState newState, TProps previous, TProps nextProps);
