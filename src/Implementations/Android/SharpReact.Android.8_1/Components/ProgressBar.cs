...
{
	public  partial class ProgressBar<TProps, TElement>: View<TProps, TElement>
		...
		where TElement : global::Android.Widget.ProgressBar
	{
		...
		public override void AssignProperties(ISharpRenderer<global::Android.Views.View> renderer, int level, NewState newState, TProps previous, TProps nextProps)
		{
			...
			PostAssignProgressBarProperties(renderer, level, newState, previous, nextProps);
		}
		partial void PostAssignProgressBarProperties(ISharpRenderer<global::Android.Views.View> renderer, int level, NewState newState, TProps previous, TProps nextProps);
