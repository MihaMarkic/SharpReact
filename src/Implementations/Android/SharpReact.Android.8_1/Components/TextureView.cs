...
{
	public  partial class TextureView<TProps, TElement>: View<TProps, TElement>
		...
		where TElement : global::Android.Views.TextureView
	{
		...
		public override void AssignProperties(ISharpRenderer<global::Android.Views.View> renderer, int level, NewState newState, TProps previous, TProps nextProps)
		{
			...
			PostAssignTextureViewProperties(renderer, level, newState, previous, nextProps);
		}
		partial void PostAssignTextureViewProperties(ISharpRenderer<global::Android.Views.View> renderer, int level, NewState newState, TProps previous, TProps nextProps);
