...
{
	public  partial class CalendarView<TProps, TElement>: FrameLayout<TProps, TElement>
		...
		where TElement : global::Android.Widget.CalendarView
	{
		...
		public override void AssignProperties(ISharpRenderer<global::Android.Views.View> renderer, int level, NewState newState, TProps previous, TProps nextProps)
		{
			...
			PostAssignCalendarViewProperties(renderer, level, newState, previous, nextProps);
		}
		partial void PostAssignCalendarViewProperties(ISharpRenderer<global::Android.Views.View> renderer, int level, NewState newState, TProps previous, TProps nextProps);
