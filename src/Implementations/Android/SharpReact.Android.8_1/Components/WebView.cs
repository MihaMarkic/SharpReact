...
{
	public  partial class WebView<TProps, TElement>: AbsoluteLayout<TProps, TElement>
		...
		where TElement : global::Android.Webkit.WebView
	{
		...
		public override void AssignProperties(ISharpRenderer<global::Android.Views.View> renderer, int level, NewState newState, TProps previous, TProps nextProps)
		{
			...
			PostAssignWebViewProperties(renderer, level, newState, previous, nextProps);
		}
		partial void PostAssignWebViewProperties(ISharpRenderer<global::Android.Views.View> renderer, int level, NewState newState, TProps previous, TProps nextProps);
